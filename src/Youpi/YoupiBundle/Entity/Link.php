 ...
 *
 * @ORM\Table(name="link")
 * @ORM\Entity(repositoryClass="Youpi\YoupiBundle\Repository\LinkRepository")
 */
class Link
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="nb_com", type="integer")
     */
    private $nbCom;

    /**
      * @ORM\ManyToOne(targetEntity="Youpi\UserBundle\Entity\User")
      * @ORM\JoinColumn(name="link_user_id", referencedColumnName="id")
      */
     private $user;
