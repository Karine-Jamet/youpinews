...
use Youpi\YoupiBundle\Entity\Link;
use Youpi\YoupiBundle\Form\LinkType;
...
class LinkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $links = $em->getRepository('YoupiBundle:Link')->findAll();
    ...
    {
        $link = new Link();
        $form = $this->createForm('Youpi\YoupiBundle\Form\LinkType', $link);
    ...
    {
        $deleteForm = $this->createDeleteForm($link);
        $editForm = $this->createForm('Youpi\YoupiBundle\Form\LinkType', $link);
